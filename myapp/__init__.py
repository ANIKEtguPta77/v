...
#postgres://user_eyxx_user:wXvb8GyquuhAZiEISUVtpgDDbps3w4Cd@dpg-cfnp90qrrk0eqlqedqbg-a.oregon-postgres.render.com/user_eyxx
#postgres://user_eyxx_user:wXvb8GyquuhAZiEISUVtpgDDbps3w4Cd@dpg-cfnp90qrrk0eqlqedqbg-a/user_eyxx
def create_app():
    app = Flask(__name__)

    app.config['SECRET_KEY'] = 'rocky'
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://user_eyxx_user:wXvb8GyquuhAZiEISUVtpgDDbps3w4Cd@dpg-cfnp90qrrk0eqlqedqbg-a.oregon-postgres.render.com/user_eyxx'
